...
# NetCDF dosyasını aç
# --------------------------
file_path = "TEMPO_CLDO4_L3_V04_20251004T213103Z_S012.nc"
...
for k in range(0, len(data_to_insert), batch_size):
    ...
    cursor.executemany(
        "INSERT IGNORE INTO tempo_o2o2_data (timestamp, longitude, latitude, weight) VALUES (%s, %s, %s, %s)",
        batch
    )
